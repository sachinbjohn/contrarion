...
public class Session implements Serializable
{
    ...
    //RO6
    public final AtomicLong  writelatency;
    ...
    public Session(String[] arguments) throws IllegalArgumentException
    {
        ...
        //RO6
        readlatency = new AtomicLong();
        readlatencies = new ConcurrentLinkedQueue<Long>();
        writelatency = new AtomicLong();
    ...
    // RO6: use zipfian
    public boolean useZipfianGenerator() { return useZipfian != 0; }
    
    // Khiem
    // RO6: get zipfian constant for zipfian workload
	...
	// Allow use of client library with other consistency levels for micro-benchmarks
        ...
        try {
            return new ClientLibrary(localServerIPAndPorts, "Keyspace1", this.getConsistencyLevel(), numDCs, dcIndex);
        } catch (Exception e) {
            e.printStackTrace();
