...
public final class Stress
{
    ...
    {
        INSERT, READ, RANGE_SLICE, INDEXED_RANGE_SLICE, MULTI_GET, COUNTER_ADD, COUNTER_GET, DYNAMIC, INSERTCL, FACEBOOK, FACEBOOK_POPULATE, WRITE_TXN, BATCH_MUTATE, TWO_ROUND_READ_TXN, DYNAMIC_ONE_SERVER, EXP10
    }
