...
public class StressAction extends Thread
{
 ...
 output.println("pre-genrating keys is done!!!"); 
    ...
    private void printLatencyPercentiles() {
        ...
        /*
        Expt,Key/Serv,#Serv,ValSize,Key/Read,WriteFrac,Zipf,NumClients,TotalThreads,LocalThreads,Client,NumOps,NumKeys,NumColumns,NumBytes,NUmReads,NumWrites,Duration,Throughput,Ravg,R50,R90,R99,Wavg,W50,W90,W95,W99,#Tx2R,#K2R,#aggR,#aggW,Lsum,Lavg
         */
