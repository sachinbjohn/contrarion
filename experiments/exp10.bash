        ...
        do
            ...
            do
                ...
                do
                    ...
                    do
                        echo "COPS trial=$trial value_size=$value_size write_frac=$write_frac zipf=$zipf_c numT=$numT start" >> ~/progress
                        ...
                        $kill_all_cmd
                        gather_results
                        echo "COPS trial=$trial value_size=$value_size write_frac=$write_frac zipf=$zipf_c numT=$numT finish" >> ~/progress
                    done
                done
            done
        done
